...
class MultiModalCAFE(nn.Module):
...
if __name__ == '__main__':
    ...
    batch_size = 16
    num_epochs = 50
    learning_rate = 1e-4 # gossip 0.001   (0.008 gcn_features_gossip_img_8sage_mer 0.8773)

    # 数据路径（请根据实际情况调整）
    content_path = '/usr/gao/gubincheng/article_rep/Agent/simplest_agent/feature_enr/feature/body_politic_7_42.npy'
    graph_path = '/usr/gao/gubincheng/article_rep/Agent/simplest_agent/feature_enr/feature/gcn_features_img_sage.npy'
    label_path = '/usr/gao/gubincheng/article_rep/Agent/simplest_agent/feature_enr/feature/label_politic_7_42.npy'

    # content_path = '/usr/gao/gubincheng/article_rep/Agent/simplest_agent/feature_enr/feature/body_gossip_8.npy'
    # graph_path = '/usr/gao/gubincheng/article_rep/Agent/simplest_agent/feature_enr/feature/gcn_features_gossip_img_8sage_mer.npy'  #0.8754  0.8773
    # graph_path = '/usr/gao/gubincheng/article_rep/Agent/simplest_agent/feature_enr/feature/gcn_features_gossip_img_8_mer1.npy'   # 0.8473
    # graph_path = '/usr/gao/gubincheng/article_rep/Agent/simplest_agent/feature_enr/feature/gcn_features_gossip_img_8_mer.npy'  # 0.8464
    # graph_path = '/usr/gao/gubincheng/article_rep/Agent/simplest_agent/feature_enr/feature/gcn_features_gossip_img_8.npy'   #0.8618
    # label_path = '/usr/gao/gubincheng/article_rep/Agent/simplest_agent/feature_enr/feature/label_gossip_8.npy'
    ...
    # 实例化模型
    config = Config()
    model_fusion = MultiModalCAFE(config, lambda_skl=0.4).to(device)  # gossip 0.7(0.8618)  politic 0.4
    optimizer_fusion = torch.optim.AdamW(model_fusion.parameters(), lr=learning_rate, weight_decay=1e-5)
    
    # 早停机制参数
    early_stop_patience = 8  # gossip 6 politic 8
    best_val_loss = float('inf')
    no_improve_epochs = 0

    # 训练循环：在验证集上监控性能，并添加早停机制
